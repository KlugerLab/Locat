...
class SimulationTestCase(unittest.TestCase):
    ...
    def test_simulated_data(self):
        ...
        locat_results = locat.gmm_scan_new(genes=['Gene_0'])
        ...
        self.assertAlmostEqual(1.0, gene_0_results.depletion_pval, places=8)
        self.assertAlmostEqual(1e-15, gene_0_results.concentration_pval, places=14)
        self.assertAlmostEqual(0.5004854, gene_0_results.pval, places=5)
